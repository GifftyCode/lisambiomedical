...
/* images */
import Slider1 from "../../images/hero-slide.jpeg";
import Slider2 from "../../images/slider/slider1.jpg";
import Slider3 from "../../images/slider/slider2.webp";
            ...
            <div className="container-fluid">
              <div className="slide-content">
                <div className="slide-title">
                  <h2>Your Partner in Fertility Success</h2>
                </div>
                <div className="slide-btns">
                  ...
                  >
                    Request Quote <i className="flaticon-right-arrow"></i>
                  </Link>
                </div>
              </div>
            </div>
        ...
        <SwiperSlide>
          ...
          >
            <div className="container-fluid">
              <div className="slide-content">
                <div className="slide-title">
                  <h2>Quality IVF Equipment, Sales and Services</h2>
                </div>
                <div className="slide-btns">
                  <Link
                    onClick={ClickHandler}
